---
date: 2008-09-13
title: The unknown and causality philosophy
category: philosophy
---
...
# Knowledge
活知识, 死知识:https://www.yinwang.org/blog-cn/2019/07/12/learning-philosophy -- wangyin
...
## specific conditions
## 不知道的问题怎么办？ or 不能直接遇到的问题？
不要在意某个特定的问题， 而是关注后面隐藏的对应的model， arrange 能力。
这并不是model设计的问题, 而是conditions的问题。不是忽略or遇不到问题， 而是没有conditions.
另外，关注的是arrange，没有遇到的问题也无所谓。所以基于当前conditions, 做最好设计就OK.
没有遇到的问题是更大问题的遗漏.
## 不要忽略那些你思考不出来的看似简单的问题
## 你思考不清楚的问题，说明有很多欠缺。
...
## Simplize problems to be able to fix
