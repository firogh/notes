...
Imagination is more important than knowledge. Wanderer in darkness.
...
## Detail complexcity and dynamic complexcity - chapter 20 Rewriting the Code of The Fifith discipline.
## Code complete 2
...
## If you don't control yourself, you will be controlled by others. In turn, you lose yourself. - Firo

# In-thing and out-observing
In-thing vs out-observing: The creators are different to you, too. You are not only lack of what they created, but also ablities they used to create things. Unerstand vs create.
...
Weak, frail, vulnerable: Repeatition and recall
## Reward Mechanism: gay science, showoff
## Neural circuit: Chunk
Different behavoir; different circuit; Defines different you. [Neuroplasticity](https://en.wikipedia.org/wiki/Neuroplasticity)
Formulation of neural circuit: [Focus](https://nickgreenquist.github.io/blog/miscl/2018/04/10/Learning-How-to-Learn.html) 

# Think: Think for yourself.
Reflexivity, critical thinking, unended quest
Atifragile 
Complete: MECE (Mutually Exclusive and Collectively Exhaustive). 
Continuousness, completeness, consistency, soundness. -- Logic
Dividing: [Descartes's methods](https://en.wikipedia.org/wiki/Discourse_on_the_Method); Main/primary causes and secondary causes, Essential causes and additional causes;
...
# Metric
Scale/[level](https://en.wikipedia.org/wiki/Level_of_analysis). 
Chronicle facts describing: Onset, nuclus, coda. Beginner, intermediate, advanced. Time Archaeology
Abstraction and concrete. [由為什麼 “abstraction”不應該譯為“抽象化”談正名](https://link.medium.com/TqmKU622u1) and [Generalization](https://en.wikipedia.org/wiki/Generalization) [In order to understand the meaning you first need to understand the context. It could mean either important  or abstract or macro:](https://qr.ae/TWWiRp)
...
Learn by doing/creating: 创造/突破/结构成长
I love those who can smile in trouble, who can gather strength from distress, and grow brave by reflection. 'Tis the business of little minds to shrink, but they whose heart is firm, and whose conscience approves their conduct, will pursue their principles unto death. -Leonardo da Vinci
Mind the starter of causality: good order, expection, problem, goals, weakness, detest, disgust, all things should covered by causality including understanding Linux kernel. whatt is my goal?
...
# Think for yourself[TFY](https://en.m.wikisource.org/wiki/On_Thinking_for_Oneself)
Schopenhauver on reading and books: When we read, another person thinks for us: we merely repeat his mental process.
Schopenhauver on reading and books: From all this it may be concluded that thoughts put down on paper are nothing more than footprints in the sand: one sees the road the man has taken, but in order to know what he saw on the way, one requires his eyes.
Schopenhauer: “记录在纸上的思想，不过是像在沙上行走者的足迹而已，我们也许能看到他所走过的路径；如果我们想要知道他在路上看见些什么，则必须用我们的眼睛”
