...
知识不是被创造, 而是被看见.
# Think for oneself and learning foundation
...
solely in connection with our personal affairs; the former, however,
 is only for minds who think by nature, to whom thinking
is as natural as breathing, but who are very rare. Thus with
most scholars there is so little of it. - Schopenhaur

Sometimes, knowledge is an intimidating monster. We might be stunted by a
huge knowledge and lose the ability to think about it. And hand over ourself
to the instinct and outside world. And become a reflecting mirror or playground
for others' thoughts. -- Firo

Learning is about thinking rather than reflecting.
Light the dark in your life.
# Fallacy
Trying harder doesn't mean effectness.
# the goals of learning
1. master the abilities through practicing every day.
2. Recogize these abilities. Perhaps, word of origin
# the reverse mapping of learning
human index <- origin <- implementions/reality
# the human index retrive
keywords, origins -> deductive -> implementions
# human index-> 
Think for oneself.
...
体 --论阅读与书籍
流式思考,stepin thinking, 25 minutes, list tasks/objects(no implementation) and principle and recursive.
### 2. No implementions; 天下无码.
...
5. the codes are very complexcity and diffcult to read. Stop imediately.
Find realted keywords, google it, lwn it. 
6. if I need to learn it, try to read the articles.
7. mark it ?? or LQO
9. expand all cases, check page_check_references
# Analyzing
