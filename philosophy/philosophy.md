...
2.2 关于如何有经验合理性设计出理性连贯的框架.如何从自我开始的思考,设计?
2.2.1 逻辑连贯性
2.2.2 onset的反面不是coda, 而是nucleus.现实的因果导致, 混乱.
所以最初的设计和思考, 不是设计用法, 而是根据用法进行设计. It's named NO.
2.2.3 自动思维. 有了因, 人的大脑会自动搜寻得到过. 这部分是忽略的大部分无意义的, 重复的内容.
2.2.4 变化点, 自动思维加上变化点构成了完整的逻辑. 如果需要减少内容. 自动思维被隐去, 留下变化点.
