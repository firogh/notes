...
* Pure full objects then scalability relations and problems.
...
* 以现实和精神, 这两个词为例, 这并不是真实存在, 只是认为定义的.We don't have to remember/understand the things contrived by people. What we need to remember is the fact which leads this contriving!
